...
export class YieldRateUpdated extends ethereum.Event {
  get params(): YieldRateUpdated__Params {
    return new YieldRateUpdated__Params(this);
  }
}

export class YieldRateUpdated__Params {
  _event: YieldRateUpdated;

  constructor(event: YieldRateUpdated) {
    this._event = event;
  }

  get oldYieldRate(): BigInt {
    return this._event.parameters[0].value.toBigInt();
  }

  get newYieldRate(): BigInt {
    return this._event.parameters[1].value.toBigInt();
  }
}

export class GameVaultV1 extends ethereum.SmartContract {
  static bind(address: Address): GameVaultV1 {
    return new GameVaultV1("GameVaultV1", address);
  }
  ...
  MAX_YIELD_RATE(): BigInt {
    let result = super.call("MAX_YIELD_RATE", "MAX_YIELD_RATE():(uint256)", []);

    return result[0].toBigInt();
  }

  try_MAX_YIELD_RATE(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "MAX_YIELD_RATE",
      "MAX_YIELD_RATE():(uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getProjectedAssets(assets: BigInt, timeElapsed: BigInt): BigInt {
    let result = super.call(
      "getProjectedAssets",
      "getProjectedAssets(uint256,uint256):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(assets),
  ...
  try_lastYieldUpdate(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "lastYieldUpdate",
      "lastYieldUpdate():(uint256)",
      [],
  ...
  yieldRate(): BigInt {
    let result = super.call("yieldRate", "yieldRate():(uint256)", []);

    return result[0].toBigInt();
  }

  try_yieldRate(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("yieldRate", "yieldRate():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class SetYieldRateCall extends ethereum.Call {
  get inputs(): SetYieldRateCall__Inputs {
    return new SetYieldRateCall__Inputs(this);
  }

  get outputs(): SetYieldRateCall__Outputs {
    return new SetYieldRateCall__Outputs(this);
  }
}

export class SetYieldRateCall__Inputs {
  _call: SetYieldRateCall;

  constructor(call: SetYieldRateCall) {
    this._call = call;
  }
...
export class SetYieldRateCall__Outputs {
  _call: SetYieldRateCall;
