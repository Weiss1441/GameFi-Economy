...
export class GameGovernor__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class GameGovernor__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class GameGovernor extends ethereum.SmartContract {
  static bind(address: Address): GameGovernor {
    return new GameGovernor("GameGovernor", address);
  }
  ...
  castVoteBySig(
    ...
    let result = super.call(
      "castVoteBySig",
      "castVoteBySig(uint256,uint8,address,bytes):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(proposalId),
        ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(support)),
  ...
  castVoteWithReasonAndParamsBySig(
    ...
    let result = super.call(
      "castVoteWithReasonAndParamsBySig",
      "castVoteWithReasonAndParamsBySig(uint256,uint8,address,string,bytes,bytes):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(proposalId),
        ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(support)),
        ethereum.Value.fromAddress(voter),
  ...
  eip712Domain(): GameGovernor__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new GameGovernor__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<GameGovernor__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new GameGovernor__eip712DomainResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toString(),
        value[3].toBigInt(),
  ...
  getProposalId(
    ...
    let result = super.call(
      "getProposalId",
      "getProposalId(address[],uint256[],bytes[],bytes32):(uint256)",
      [
        ethereum.Value.fromAddressArray(targets),
        ethereum.Value.fromUnsignedBigIntArray(values),
        ethereum.Value.fromBytesArray(calldatas),
  ...
  proposalVotes(proposalId: BigInt): GameGovernor__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new GameGovernor__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_proposalVotes(
    proposalId: BigInt,
  ): ethereum.CallResult<GameGovernor__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GameGovernor__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
