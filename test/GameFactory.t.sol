...
contract GameFactoryTest is Test {
    ...
    function test_deployGameCREATE2_deterministicAddress() public {
        ...
        (address predictedParams, address predictedItems) = factory.predictAddressCREATE2(GAME_NAME, GAME_SYMBOL, salt);

        vm.prank(user1);
        (address actualItems, address actualParams) = factory.deployGameCREATE2(GAME_NAME, GAME_SYMBOL, salt);
    ...
    function test_predictAddressCREATE2_returnsAddress() public view {
        ...
        (address params, address items) = factory.predictAddressCREATE2(GAME_NAME, GAME_SYMBOL, salt);
    ...
    function test_predictAddressCREATE2_consistent() public view {
        ...
        (address params1, address items1) = factory.predictAddressCREATE2(GAME_NAME, GAME_SYMBOL, salt);

        (address params2, address items2) = factory.predictAddressCREATE2(GAME_NAME, GAME_SYMBOL, salt);
    ...
    function test_predictAddressCREATE2_differentNameDifferentAddress() public view {
        ...
        (address params1, address items1) = factory.predictAddressCREATE2("Game A", "GA", salt);

        (address params2, address items2) = factory.predictAddressCREATE2("Game B", "GB", salt);
